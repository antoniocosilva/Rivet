...
rivet --pwd -p $ANALYSIS_DIR/Centrality/calibration_AuAu_200GeV_STAR.yoda -a Nolan_2020_I0000000:cent=GEN -o Angantyr.yoda $PYTHIA_EX_DIR/hepmc_AuAu_200GeV_500Events.hepmc
