 #!/bin/bash
ANALYSIS_DIR=/home/antoniosilva/RivetWorkdir/Nolan
PYTHIA_EX_DIR=/home/antoniosilva/RivetWorkdir/Pythia8/pythia8243/examples
...
rm *.so
export RIVET_ANALYSIS_PATH=$PWD
rivet-buildplugin RivetNolan_2020_I0000000.so Nolan_2020_I0000000.cc
rivet --pwd -p $ANALYSIS_DIR/Centrality/calibration_AuAu_200GeV_STAR.yoda -a Nolan_2020_I0000000:cent=GEN -o Angantyr.yoda $PYTHIA_EX_DIR/hepmc_AuAu_MB_1.hepmc
